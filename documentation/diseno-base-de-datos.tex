...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{images/poblar-db.png}
    \caption{Tablas de la base de datos de asistencia}
    \label{fig:tablas-asistencia}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{images/create-index.png}
    \caption{Creacion de indices}
    \label{fig:indices-asistencia}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{images/vistas.png}
    \caption{Creacion de vistas}
    \label{fig:vistas-asistencia}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{images/procedure.png}
    \caption{Creacion de procedimientos almacenados}
    \label{fig:procedimientos-asistencia}
\end{figure}
\subsubsection*{Triggers}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{images/triggers.png}
    \caption{Creacion de triggers}
    \label{fig:triggers-asistencia}
\end{figure}
